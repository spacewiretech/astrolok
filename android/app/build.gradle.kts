...
android {
    ...
    // compiled against 37, and the manifest merger refuses a lower compileSdk.
    compileSdk = 37
    ...
    buildFeatures {
        // Off by default from AGP 9. The Facebook App ID and Client Token below are generated
        // rather than checked in, and generating them is what keeps the credentials in one place.
        resValues = true
    }

    defaultConfig {
        // TODO: Specify your own unique Application ID (https://developer.android.com/studio/build/application-id.html).
        applicationId = "com.spacewire.astrolok"
        ...
        // is all digits: `android:value="1234..."` is parsed as an integer and overflows, which
        // is the classic way this integration fails silently.
    ...
    buildTypes {
        release {
            // TODO before the first Play upload: generate an upload keystore and point a real
            // signingConfig at it via android/key.properties (both gitignored). Until then this
            // signs with the debug key, which Play will reject.
