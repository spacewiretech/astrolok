...
/// having, is the lowest-opt-in placement there is. This is called when the paywall opens
/// instead: onboarding is behind the user, they are looking at the offer, and — the part that
/// actually matters — it is still *before* the purchase, so a granted IDFA is attached to the
/// conversion event rather than arriving a screen too late.
///
