...
///
/// Deliberately independent of the app: no `ProviderScope`, no repositories, no `Env`, no
/// network. It borrows only the brand — `AppColors`, the wordmark and the onboarding mockups.
class AstrolokSiteApp extends StatelessWidget {
  const AstrolokSiteApp({super.key, this.router});
