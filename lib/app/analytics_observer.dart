...
/// `RouteSettings.name` — it passes `state.name ?? state.path`, and none of these routes are given
/// a `name`. Three consequences worth knowing:
///
...
const _screenNames = <String, String>{
  ...
  Routes.palmScan: 'Palm Scan',
  Routes.palmReading: 'Palm Reading',
  Routes.palmLine: 'Palm Line',
  Routes.faceCapture: 'Face Capture',
  Routes.faceScan: 'Face Scan',
  Routes.faceReading: 'Face Reading',
  Routes.facePart: 'Face Part',
  Routes.chat: 'Chat',
...
const _modalNames = <String, String>{
  ...
  'rename-thread': 'Rename Thread Dialog',
